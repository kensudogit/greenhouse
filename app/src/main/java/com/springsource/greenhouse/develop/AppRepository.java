...
/**
 * Data access interface for managing client Applications and the member account
 * connections established with them.
 * 
 * @author Keith Donald
 */
public interface AppRepository {
	 ...
	 * @return the new app slug, which may have changed if the app's name has also
	 *         changed.
	 */
	 ...
	 * Used by the developer when they no longer wish to connect their application
	 * to this system.
	 * 
	 * @param accountId the member account id
	 * @param slug      a short, meaningful key that identifies the application
	 ...
	 * @return a short, meaningful key that identifies the application; designed to
	 *         be used to redirect the user to the app details view.
	 */
	 ...
	 * Used to present details of the application to a member during connection
	 * authorization.
	 * 
	 * @param apiKey the assigned api key, submitted by the client application
	 *               itself on behalf of the member
	...
	/**
	 * Get a list of applications connected to a member account.
	 * 
	 * @param accountId the member account id
	 * @return a list of maps containing application details
	 */
	List<Map<String, Object>> findConnectedApps(Long accountId);
