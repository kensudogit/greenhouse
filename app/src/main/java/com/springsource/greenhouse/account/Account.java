...
public class Account implements Serializable, Principal {
	 ...
	 * The profileUrl parameter is a UriTemplate to allow the URL to be re-generated
	...
	public Account(Long id, String firstName, String lastName, String email, String username, String pictureUrl,
		...
		this(id, firstName, lastName, email, username, pictureUrl, profileUrlTemplate, null);
	}

	public Account(Long id, String firstName, String lastName, String email, String username, String pictureUrl,
			UriTemplate profileUrlTemplate, Gender gender) {
		this.id = id;
	...
	/**
	 * The gender of the person associated with this account.
