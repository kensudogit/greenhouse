...
public interface MailInviteService {
	 ...
	 * @param invitationBody the member's personalized invitation body, which may be
	 *                       a template that contains $invitee$ variable references
	 *                       referring to Invitee properties.
	 */
	 ...
	 * @param text  the invitation email text
