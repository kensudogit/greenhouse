...
class EventSessionData {
	...
	/**
	 * Constructs EventSessionData with all required fields directly.
	 */
	public EventSessionData(long event, int id, String title, String description, String hashtag,
			Long venue, Long timeslot, String source, long sourceId, List<Long> leaderIds) {
		this.event = event;
		this.id = id;
		this.title = title;
		this.description = description;
	...
	/**
	 * Constructs EventSessionData using EventDetails object.
	 */
