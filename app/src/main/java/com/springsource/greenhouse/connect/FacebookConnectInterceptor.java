...
/**
 * Supports posting to the user's wall on behalf of the user after connecting to Facebook.
 * Also supports using the user's Facebook profile picture as the local profile picture.
 * 
 * @author Keith Donald
 */
public class FacebookConnectInterceptor implements ConnectInterceptor<Facebook> {
	...
	/**
	 * Performs actions before connecting to Facebook.
	 * Sets up wall posting and profile picture usage based on request parameters.
	 */
	@Override
	...
	/**
	 * Performs actions after connecting to Facebook.
	 * Posts to user's wall and uses Facebook profile picture if requested.
	 */
	@Override
	...
	/**
	 * Posts a link to the user's wall if requested.
	 * 
	...
	/**
	 * Saves Facebook profile picture as local profile picture if requested.
	 * 
	 * @param connection Facebook connection
	 * @param account    current account
	 * @param request    web request
