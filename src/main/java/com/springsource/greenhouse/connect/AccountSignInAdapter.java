...
/**
 * ユーザーがプロバイダーアカウントでサインインするのをサポートするために使用されます。
 * このクラスは、ユーザーIDを使用してアカウントを検索し、サインインを処理します。
 * 
 * @author Keith Donald
 */
public class AccountSignInAdapter implements SignInAdapter {
	...
	/**
	 * ユーザーIDを使用してアカウントを検索し、サインインを処理します。
	 * 
	 * @param userId     ユーザーID
	 * @param connection ソーシャル接続
	 * @param request    ネイティブWebリクエスト
	 * @return 元のURL
	 */
